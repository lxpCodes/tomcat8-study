...
public class Catalina {
    ...
    protected Digester createStartDigester() {
        ...
        log.info("Digester配置将要执行的动作,创建Java对象或者执行某个方法");
        log.info("创建StandardServer实例");
    ...
    public void load() {
        ...
        // Create and execute our Digester
        log.info("实例化组件");
        //Digester是一种将xml转化为java对象的事件驱动型工具，
        //通过读取xml文件，当识别到特定的节点的时候会执行特定的动作，创建java对象或者执行对象的某个方法
